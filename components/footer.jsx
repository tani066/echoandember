                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/echonember.in/" className="w-10 h-10 rounded-full bg-pink-50 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors">
