                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li><Link href="/shipping" className="hover:text-primary transition-colors">Shipping Returns & Payments</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/echoandember.in/" className="w-10 h-10 rounded-full bg-pink-50 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors">
